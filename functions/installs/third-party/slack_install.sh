...
function slack_install {
	...
	if [ "" == "$PKGCHECK" ]; then
		...
		case `uname -i` in
			i386|i486|i586|i686)
				curl -O https://downloads.slack-edge.com/linux_releases/slack-desktop-2.5.2-i386.deb
				;;
			x86_64)
				curl -O https://downloads.slack-edge.com/linux_releases/slack-desktop-2.5.2-amd64.deb
				;;
			*)
